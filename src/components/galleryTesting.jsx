...
export default function Counter(props) {
    ...
    return (
        <div>
            <button onClick={handleShow} data-modal-target="default-modal" data-modal-toggle="default-modal" className="block w-28 hover:bg-gray-700 text-white text-sm rounded text-center" type="button">Profile picture</button>
